    if (document.querySelectorAll('.jalendar').length) {(function (c) {
        c.fn.jalendar = function (f) {
            function C() {
                ...
                n.setFullYear(p, h, 0);
                n = n.getDay() + A;
                a.find(".header h3").html(m[b.lang][h] + " " + `<span>${p}</span>` + '<div class="total-bar"></div>');
                ...
                for (d = 1; d <= u[h]; d++) {
                    ...
                    "dd-mm-yyyy" == b.dateType
                        ? (f = d + "-" + e + "-" + p)
                        : "mm-dd-yyyy" == b.dateType
                        ? (f = e + "-" + d + "-" + p)
                        : "yyyy-mm-dd" == b.dateType
                        ? (f = p + "-" + e + "-" + d)
                        : "yyyy-dd-mm" == b.dateType && (f = p + "-" + d + "-" + e);
                    "linker" == b.type
                        ? a
                              .find(".day")
                              .eq(n - 1)
                              .addClass("this-month")
                              .attr("data-date", f)
                              .html('<span><a href="' + b.customUrl + f + '">' + d + "</a></span>")
                        : a
                              .find(".day")
                              .eq(n - 1)
                              .addClass("this-month")
                    ...
                    1 == b.selectingBeforeToday &&
                        k > l &&
                        a
                            .find(".day")
                            .eq(n - 1)
                            .addClass("disable-selecting");
                    1 == b.selectingAfterToday &&
                        k < l &&
                        a
                            .find(".day")
                            .eq(n - 1)
                ...
                h == y.getMonth() && p == y.getFullYear()
                    ? a
                          .find(".day.this-month")
                          .removeClass("today")
                          .eq(L - 1)
                          .addClass("today")
                    : a.find(".day.this-month").removeClass("today").attr("style", "");
                a.find(".added-event").each(function (b) {
                    c(this).attr("data-id", b);
                    a.find('.this-month[data-date="' + c(this).attr("data-date") + '"]')
                        .addClass("have-event " + c(this).data("type"))
                        .append(
                            g("div", "event-single")
                                .attr("data-id", b)
                                .append(g("a", "").attr("href", c(this).attr("data-link")).attr("target", "blank").html(
                                        `
                                        <div class="event-head">
                                        <div class="event-head__ball" style="background-color: ${c(this).attr("data-color")};"></div>
                                        <div class="event-head__time">${c(this).attr("data-start")} - ${c(this).attr("data-end")}</div>
                                    ...
                                    <div class="event__body">${c(this).attr("data-title")}</div>
                                    `
                                ))
                        );
                });
                ...
                null !== b.titleColor && a.find(".header h3, .header .prv-m, .header .nxt-m, .event-single p, h3, .close-button").css({ color: b.titleColor });
                ...
                ("#fff" != b.color && "#ffffff" != b.color && "white" != b.color) || a.find(".header h3, .header .prv-m, .header .nxt-m, .day.today span, h2, .event-single p, h3, .close-button").css({ "text-shadow": "none" });
            }
            function M() {
            ...
            function G() {
                ...
                if (null !== l)
                    if (0 == a.find('[data-date="' + x.val() + '"]').length) {
                        ...
                        else if ((v > Number(a.find(".days").attr("data-month")) && q <= Number(a.find(".days").attr("data-year"))) || q > Number(a.find(".days").attr("data-year"))) l = 42;
                        if (null !== B) {
                            if (q == w && v == z) return !1;
            ...
            function H() {
                ...
                a.find('.day[data-date="' + x.val() + '"]')
                    .nextUntil('.day[data-date="' + t.val() + '"]')
                    .addClass("range");
                0 < a.find('.day[data-date="' + t.val() + '"]').length &&
                    (0 < a.find(".day.first-range").length
                        ? a.find(".day.first-range").nextUntil(".day.last-range").addClass("range")
                        : (a
                              .find(".day:eq(" + l + ")")
                              .nextUntil(".day.last-range")
                              .addClass("range"),
                          0 == l && a.find(".day:eq(0)").addClass("range")));
            }
            var b = c.extend(
                {
                    customDay: new Date(),
            ...
            a.append(
                c('<input type="hidden" class="data1" /><input type="hidden" class="data2" />'),
                g("div", "jalendar-container").append(
                    g("div", "jalendar-pages")
                        .append(
                            g("div", "header").append(g("a", "prv-m").append(g("i", "fa fa-angle-left")), g("h3"), g("a", "nxt-m").append(g("i", "fa fa-angle-right")), g("div", "day-names")),
                            g("div", "days"),
                            g("div", "add-event").append(g("div", "events").append(g("div", "events-date"), g("div", "events-list")))
                        )
                        .attr(
                            "style",
                            "background-color:" +
            ...
            "range" == b.type &&
                a
                    .find(".jalendar-pages")
                    .addClass("range")
                    .append(g("input", "first-range-data").attr({ type: "hidden" }), g("input", "last-range-data").attr({ type: "hidden" }));
            ...
            f[0].on("click", function () {
                let dayClick = a.find(".this-month");
                0 === h ? ((h = 11), p--) : h--;
                C();
                D();
                "range" == b.type && (G(), H());
            ...
            a.on("click", ".this-month:not(.disable-selecting)", function () {
                let todayStr = '';
                if (new Date(a.find(".this-month.selected").attr("data-date")) === new Date()) {
                    todayStr = 'Сегодня';
                } else {
                    todayStr = 'Дата';
                }
                if ("selector" == b.type)
                    return (
                        c(this).parent().find(".selected").removeClass("selected"),
                        c(this).addClass("selected"),
                        a.find("input.data1").val(a.find(".this-month.selected").attr("data-date")),
                        a.parent().is(".jalendar-input") && (a.parent().find("input").removeClass("selected"), a.parent(".jalendar-input").find("input").val(c(this).data("date"))),
                ...
                if ("range" == b.type) {
                    ...
                    if (null !== l)
                        if (null !== B) d(c(this));
                            ...
                            a.parent().is(".jalendar-input") &&
                                (a.parent().find("input").removeClass("selected"),
                                a
                                    .parent(".jalendar-input")
                                    .find("input")
                                    .val(a.find("input.data1").val() + ", " + a.find("input.data2").val()));
                            null !== b.done && b.done.call(this);
                        }
                    else d(c(this));
                    a.on(
                        {
                            mouseenter: function () {
                                if (null === l) return !1;
                                "" === t.val() &&
                                    (a.find(".day").removeClass("range last-range"),
                                    c(this).index() > l &&
                                        c(this).hasClass("this-month") &&
                                        (c(this).addClass("last-range"),
                                        c(this)
                                            .parent()
                                            .find(".day:eq(" + l + ")")
                                            .nextUntil(".this-month.last-range")
                                            .addClass("range"),
                                        0 == l && c(this).parent().find(".day:eq(0)").addClass("range")));
                            },
                            mouseleave: function () {
                ...
                D();
                "" === b.type &&
                    (a.find("input.data1").val(c(this).data("date")),
                    c(this).addClass("selected"),
                    a.find(".add-event").find(".events-list").html(e.clone()),
                    a.find(".add-event").find(".events-date").html(`<span>${todayStr}</span> `+c(this).data("date").replaceAll('-', '/')),
                    a.parent().is(".jalendar-input") && a.parent(".jalendar-input").find("input").val(c(this).data("date")),
                    0 <= a.find(".events .event-single").length && a.find(".events h3 span").html(a.find(".events .event-single").size()),
                    a
                        .find(".add-event")
                        .addClass("selected")
                        .height(a.find(".add-event .events").height() + 59));
            });
            if (a.parent().is(".jalendar-input"))
                a.parent(".jalendar-input")
